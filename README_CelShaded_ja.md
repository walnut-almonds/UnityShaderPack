...
**150以上のパラメータ**を持つ、フル機能で高度にカスタマイズ可能なセルシェーディング（Cel-Shaded/Toon）Unity Shaderです。様々なNPR（非写実的レンダリング）のニーズに対応します。
...
### 🎯 コア機能
- ✅ **多段階シャドウ** - 1〜10段階の調整可能なシャドウ
- ✅ **アウトラインレンダリング** - 幅、色、距離フェードをカスタマイズ可能
- ✅ **マルチテクスチャレイヤー** - 3つのメインテクスチャレイヤー、複数のブレンドモード対応
- ✅ **柔軟なライティング制御** - 明度、彩度、色相の完全な調整
- ✅ **MatCapサポート** - 3つのMatCapレイヤーで環境反射を簡単に追加
